...
/*    static {
     ...
     */
    public Form(int width, int height, int stayTime, int style, String title, String message) {
        this.width = width;
        this.height = height;
    ...
    public Form(int stayTime, int style, String title, String message) {
        this.width = 300;
        this.height = 100;
        this.stayTime = stayTime;
        this.style = style;
    ...
    public static void showDialog( String title,String message){
        ...
        Form tipWindow = new Form(1, JRootPane.QUESTION_DIALOG, title, message);
        tipWindow.run();
    }

    public static void main(String[] args) {
        showDialog("1","jjjjjjjj");
    }
}